                        ...
                        <div class="widget-info product-cat boxscrol2" data-filter-group="brand">
                            <ul class="treeview">
                                @foreach($brands as $brand)
                                    <li><a href="{{url('/productByBrand/'.$brand->id)}}"><i class="zmdi zmdi-dot-circle"></i> {{$brand->brandName}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <aside class="widget widget-banner hidden-sm">
                        <div class="widget-info widget-banner-img">
                            @foreach($banners as $banner)
                                <a href="{{$banner->banner_link_brand_single_page}}"><img src="{{asset('storage/images/banner/'.$banner->banner_brand_single_page)}}" alt="" /></a>
                            @endforeach
                        </div>
                    </aside>
                    <!-- Widget-banner end -->
