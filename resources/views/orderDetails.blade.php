									...
									<div>
										<form action="#">
											<div class="thank-recieve bg-white mb-30">
												<p>Order <mark>#{{$order->id}}</mark> was placed on <mark>{{$order->created_at}}</mark> and is currently <mark>
													@if($order->status  == 0)
														On hold
											...
											<div class="order-info bg-white text-center clearfix mb-30">
												...
												<div class="single-order-info">
													...
													<p class="text-uppercase text-light-black mb-0"><strong>৳ {{number_format($total_price+($total_price*0.15)+15, 2)}}</strong></p>
												</div>
												<div class="single-order-info">
													...
													<div class="col-md-6 col-sm-6 col-sm-12">
														<div class="our-order payment-details pr-20">
															...
															<table>
																...
																<tr>
																	<td>Cart Subtotal</td>
																	<td class="text-right">৳ {{number_format($cart_subtotal, 2)}}</td>
																</tr>
																...
																<tr>
																	<td>Vat (15%)</td>
																	<td class="text-right">৳ {{number_format($total_price*0.15, 2)}}</td>
																</tr>
																<tr>
																	<td>Order Total</td>
																	<td class="text-right">৳ {{number_format($total_price+($total_price*0.15)+15, 2)}}</td>
																</tr>
																</tbody>
															</table>
														</div>
