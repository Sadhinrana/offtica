                        ...
                        <div class="widget-info product-cat boxscrol2" data-filter-group="industry">
                            <ul class="treeview">
                                @foreach($industries as $industry)
                                    <li><a href="{{url('/productByIndustry/'.$industry->id)}}"><i class="zmdi zmdi-dot-circle"></i> {{$industry->industryName}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <aside class="widget widget-banner hidden-sm">
                        <div class="widget-info widget-banner-img">
                            @foreach($banners as $banner)
                                <a href="{{$banner->banner_link_industry_single_page}}"><img src="{{asset('storage/images/banner/'.$banner->banner_industry_single_page)}}" alt="" /></a>
                            @endforeach
                        </div>
                    </aside>
                    <!-- Widget-banner end -->
