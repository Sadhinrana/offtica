            ...
            <div class="row">
                <div class="col-md-3 col-sm-12 col-xs-12">
                    ...
                    <aside class="widget widget-categories  mb-30">
                        ...
                        <div class="widget-info product-cat boxscrol2" data-filter-group="brand">
                            <ul class="treeview">
                                <li><a href="#" class="button is-checked" data-filter=""><i class="zmdi zmdi-dot-circle"></i> All</a></li>
                                @foreach($brands as $brand)
                                    <li><a href="{{url('/productByBrand/'.$brand->id)}}" class="button" data-filter=".{{$brand->id}}"><i class="zmdi zmdi-dot-circle"></i> {{$brand->brandName}}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <aside class="widget widget-banner hidden-sm">
                        <div class="widget-info widget-banner-img">
                            @foreach($banners as $banner)
                                <a href="{{$banner->banner_link_brand_page}}"><img src="{{asset('storage/images/banner/'.$banner->banner_brand_page)}}" alt="" /></a>
                            @endforeach
                        </div>
                    </aside>
                    <!-- Widget-banner end -->
                    ...
                    <div class="shop-content mt-tab-30 mt-xs-30">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="grid-view">
                                ...
                                @foreach($products as $product)
                                    <!-- Single-product start -->
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 product {{$product->brand->id}} @foreach($product->colors as $color){{$color->color}} @endforeach @foreach($product->sizes as $size){{$size->size}} @endforeach" data-price="{{$product->salePrice}}">
                            ...
                            <div class="tab-pane" id="list-view">
                                ...
                                @foreach($products as $product)
                                    <!-- Single-product start -->
                                        <div class="col-lg-12 productList {{$product->brand->id}} @foreach($product->colors as $color){{$color->color}} @endforeach @foreach($product->sizes as $size){{$size->size}} @endforeach" data-price="{{$product->salePrice}}">
