...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('dashboard')}}" class="logo">
            ...
            <span class="logo-lg"><b>Offtica</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @php
                                $messages = \App\Message::where('confirmed', false)->get();
                            @endphp
                                ...
                                <ul class="menu">
                                    ...
                                    <li><!-- start message -->
                                        <a href="{{url('messages/'.$message->id)}}">
                                            <div class="pull-left">
                                                <img src="{{asset('img/reviewer/user.png')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                {{$message->name}}
                    ...
                    <li class="dropdown notifications-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @php
                                $orders = \App\Order::whereDate('created_at', '=', \Carbon\Carbon::today())->get()->count();
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-folder"></i> <span>Site Info</span>
                        <span class="pull-right-container">
                          <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('banners')}}"><i class="fa fa-circle-o"></i> Banner</a></li>
                        <li><a href="{{url('siteinfos')}}"><i class="fa fa-circle-o"></i> Site Info</a></li>
                        <li><a href="{{url('abouts')}}"><i class="fa fa-circle-o"></i> About</a></li>
                        <li><a href="{{url('contacts')}}"><i class="fa fa-circle-o"></i> Contact</a></li>
                        <li><a href="{{url('partners')}}"><i class="fa fa-circle-o"></i> Partner</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('subcategories')}}"><i class="fa fa-circle-o"></i> Subcategory</a></li>
                        <li><a href="{{url('minicategories')}}"><i class="fa fa-circle-o"></i> MiniCategory</a></li>
                        <li><a href="{{url('brands')}}"><i class="fa fa-circle-o"></i> Brand</a></li>
                        <li><a href="{{url('industries')}}"><i class="fa fa-circle-o"></i> Industry</a></li>
                        <li><a href="{{url('colors')}}"><i class="fa fa-circle-o"></i> Color</a></li>
                        <li><a href="{{url('sizes')}}"><i class="fa fa-circle-o"></i> Size</a></li>
                        ...
                        <li><a href="{{url('deals')}}"><i class="fa fa-circle-o"></i> Deals</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('clients')}}"><i class="fa fa-circle-o"></i> Client</a></li>
                        <li><a href="{{url('orders')}}"><i class="fa fa-circle-o"></i> Order</a></li>
                        <li><a href="{{url('discounts')}}"><i class="fa fa-circle-o"></i> Coupon</a></li>
                        <li><a href="{{url('membership_types')}}"><i class="fa fa-circle-o"></i> Membership Type</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-folder"></i> <span>Salesman</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('salesmen')}}"><i class="fa fa-circle-o"></i> Salesman</a></li>
                        <li><a href="{{url('salesmantargets')}}"><i class="fa fa-circle-o"></i> Salesman target</a></li>
                    </ul>
                </li>
            </ul>
        </section>
