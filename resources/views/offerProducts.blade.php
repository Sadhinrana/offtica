                    ...
                    <div class="shop-content mt-tab-30 mt-xs-30">
                        <div class="product-option mb-30 clearfix">
                            ...
                            <div class="showing text-right hidden-xs">
                                <p class="mb-0">Showing {{$offers->firstItem()}}-{{$offers->lastItem()}} of  {{$offers->total()}} Results</p>
                            </div>
                        </div>
                        <!-- Tab panes -->
                            ...
                            <div class="tab-pane active" id="grid-view">
                                ...
                                @foreach($offers as $offer)
                                    @foreach($offer->products as $product)
                                        @php
                                            $price = $product->salePrice-(($product->salePrice*$offer->discount_value)/100);
                                        @endphp
